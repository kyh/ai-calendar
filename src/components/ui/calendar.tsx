...
const CalendarRoot = ({ className, rootRef, ...props }: React.ComponentProps<typeof Root>) => (
  <div data-slot="calendar" ref={rootRef} className={cn(className)} {...props} />
);

const CalendarWeekNumber = ({ children, ...props }: React.ComponentProps<typeof WeekNumber>) => (
  <td {...props}>
